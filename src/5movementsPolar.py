...
def main():
    ...
    draw.lines([0,0,heighthPaper,heightPaper],[0,widthPaper,widthPaper,0],xOffset = -heightPaper/2.0,yOffset =20,polar = True)
    try:
    ...
    try:
        for j in range(0,nx):
            ...
            X2 = drawing(kFrames,kinect.frames,angle,angleZ,draw,nLines = np.int(nL[j]),scale = scale,A0=0,\
